...
class Property(TimeStampedUUIDModel):
    ...
    title = models.CharField(verbose_name=_("Property Titile"), max_length=250)
    slug = AutoSlugField(populate_from = "title", unique=True, always_update=True)
    ref_code = models.CharField(verbose_name=_("Property Reference Code"), max_length=255, blank=True)
    description = models.TextField(verbose_name=_("Description"), default="Default description...please update...")
    country = CountryField(verbose_name=_("Country"), default="KE", blank_label = "(selected country)")
    ...
    cover_photo = models.ImageField(verbose_name=_("Main Photo"), default="/house_sample.jog", null=True, blank=True)
    ...
    views = models.IntegerField(verbose_name=_("Totall Views"), default=0)
