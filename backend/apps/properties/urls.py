...
urlpatterns = [
    ...
    path("details/<slug:slug>/", views.PropertyDetailView.as_view(), name="property-detials"),
    path("update/<slug:slug>/", views.update_property_api_view, name="update-property-api"),
    path("delete/<slug:slug>/", views.delete_property_api_view, name="delete-property"),
    path("serach/", views.PropertySearchAPIView.as_view(), name="property-serach"),
]