# Generated by Django 3.2.7 on 2022-01-06 19:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=250, verbose_name='Property Titile')),
                ('slug', autoslug.fields.AutoSlugField(always_update=True, editable=False, populate_from='title', unique=True)),
                ('ref_code', models.CharField(blank=True, max_length=255, verbose_name='Property Reference Code')),
                ...
                ('property_type', models.CharField(choices=[('House', 'House'), ('Apartment', 'Apartment'), ('Officr', 'Officr'), ('Warehouse', 'Warehouse'), ('Commercial', 'Commercial'), ('Other', 'Other')], default='Other', max_length=50, verbose_name='Property Type')),
                ('cover_photo', models.ImageField(blank=True, default='/house_sample.jog', null=True, upload_to='', verbose_name='Main Photo')),
                ...
                ('views', models.IntegerField(default=0, verbose_name='Totall Views')),
            ],
            options={
