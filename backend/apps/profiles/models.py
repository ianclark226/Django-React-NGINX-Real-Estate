...
class Profile(TimeStampedUUIDModel):
    ...
    max_length=30, default="+1111111111")
    ...
    profile_photo = models.ImageField(verbose_name=_("Profile Photo"), default="/profile_default.jpeg")
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Aston", blank=False, null=False)
